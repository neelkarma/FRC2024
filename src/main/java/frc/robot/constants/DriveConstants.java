...
public class DriveConstants {
  ...
  public static final double DRIVING_ENCODER_VELOCITY_FACTOR = DRIVING_ENCODER_POSITION_FACTOR / 60.0; // meters
                                                                                                       // per
                                                                                                       // second
  ...
  public static final double TURNING_ENCODER_VELOCITY_FACTOR = TURNING_ENCODER_POSITION_FACTOR / 60.0; // radians
                                                                                                       // per
                                                                                                       // second

  /** Turning Encoder Position PID Min Input in radians */
  public static final double TURNING_ENCODER_POSITION_PID_MIN_INPUT = 0;
  /** Turning Encoder Position PID Max Input in radians */
  public static final double TURNING_ENCODER_POSITION_PID_MAX_INPUT = TURNING_ENCODER_POSITION_FACTOR;

  /** Swerve Module Driving motor PID P */
  public static final double DRIVE_P = 0;
  /** Swerve Module Driving motor PID I */
  public static final double DRIVE_I = 0;
  /** Swerve Module Driving motor PID D */
  public static final double DRIVE_D = 0;
  /** Swerve Module Driving motor PID Feedforward gain */
  public static final double DRIVING_FF = 0;// 1 / DRIVE_WHEEL_FREE_SPEED_RPS;

  /** Swerve Module Turning motor PID P */
  public static final double TURNING_P = 0.05;// .015;
  /** Swerve Module Turning motor PID I */
  public static final double TURNING_I = 0.00001;
  /** Swerve Module Turning motor PID D */
  public static final double TURNING_D = 0;// .001;
  /** Swerve Module Turning motor PID Feedforward gain */
